         ...
         <form action="index.php" method="post">
            ...
            <div class="input-area">
               <input type="text" name="email"
                      class="<?= empty($signInForm->errors_sign['email']) ? '' : 'error-input' ?>"
                      value="<?= $signInForm->getEmail(); ?>"/>
               <span class="floating-labels">Email address</span>
               <span class="error-span"><?php echo $signInForm->errors_sign['email']; ?></span>
            </div>
            <div class="input-area">
               <input type="password" name="password"
                      class="<?= empty($signInForm->errors_sign['password']) ? '' : 'error-input' ?>"/>
            ...
            <div class="form-footer">
               <p class="form-paragraph">Not registered?
                  <button type="button" class="footer-btn" id="create-account-link">Create account</button>
               </p>
            </div>
         </form>
      </div>
         ...
         <form action="index.php" method="post">
            ...
            <div class="input-area">
               <input type="text" name="fname"
                      class="<?= empty($registerForm->errors_register['fname']) ? '' : 'error-input' ?>"
                      value="<?php echo $registerForm->getFname(); ?>"/>
               <span class="floating-labels">First name</span>
               <span class="error-span"><?php echo $registerForm->errors_register['fname']; ?></span>
            </div>
            <div class="input-area">
               <input type="text" name="lname"
                      class="<?= empty($registerForm->errors_register['lname']) ? '' : 'error-input' ?>"
                      value="<?= $registerForm->getLname(); ?>"/>
               <span class="floating-labels">Last name</span>
               <span class="error-span"><?php echo $registerForm->errors_register['lname']; ?></span>
            </div>
            <div class="input-area">
               <input type="text" name="email"
                      class="<?= empty($registerForm->errors_register['email']) ? '' : 'error-input' ?>"
            ...
            <div class="input-area">
               <input type="password" name="password"
                      class="<?= empty($registerForm->errors_register['password']) ? '' : 'error-input' ?>"/>
               <span class="floating-labels">Password</span>
            ...
            <div class="form-footer">
               <p class="form-paragraph">Already have an account?
                  <button type="button" class="footer-btn" id="sign-in-link">Sign in</button>
               </p>
            </div>
         </form>
      </div>
